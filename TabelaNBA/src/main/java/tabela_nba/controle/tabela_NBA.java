    ...
    public void confrontos() {
        ...
        do {
            ...
            if (i != j) {
                ...
                if (listaTimes.get(i).getConferencia() == listaTimes.get(j).getConferencia() && listaTimes.get(i).getDivisao() != listaTimes.get(j).getDivisao()) {
                    for (loop = 0; loop < 4; loop++) {
                        vencedor = rand.nextInt(2);
                        embates(i, j, vencedor);
                    }
                }
                if (listaTimes.get(i).getConferencia() == listaTimes.get(j).getConferencia()) {
                ...
                j = rand.nextInt(QUANTIDADE_TIMES);
            }
